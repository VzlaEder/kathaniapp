...
exports.GlucoseService = void 0;
var core_1 = require("@angular/core");
var rxjs_1 = require("rxjs");
var GlucoseService = /** @class */ (function () {
    function GlucoseService(httpService) {
        this.httpService = httpService;
        this.glucoseH = new rxjs_1.BehaviorSubject([]);
    }
    GlucoseService.prototype.changeGlucoseHistory = function (data) {
        this.glucoseH.next(data);
    };
    GlucoseService.prototype.glucoseHistory = function () {
...
exports.GlucoseService = GlucoseService;
